...
/****************************************************************************/
/* Define for stm32fxx*/  //while(USART_GetFlagStatus(UART5) == RESET); USART_SendData(UART5,i);
...
#define ZW_UART_WAIT_RECEIVE    while(USART_GetFlagStatus(ZM_UART,USART_FLAG_RXNE) == RESET);
#define ZW_UART_REC_BYTE        USART_ReceiveData(ZM_UART);
#define ZW_UART_REC_STATUS      USART_GetFlagStatus(ZM_UART,USART_FLAG_RXNE)
#endif


//USART_GetFlagStatus(USART_TypeDef* USARTx, uint16_t USART_FLAG)
//void USART_SendData(USART_TypeDef* USARTx, uint16_t Data) FlagStatus USART_GetFlagStatus(USART_TypeDef* USARTx, uint16_t USART_FLAG)
/****************************************************************************/
/*                              EXPORTED DATA                               */
/****************************************************************************/
/* Serial buffer size */
